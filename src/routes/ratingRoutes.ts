...
class RatingRoutes {
  ...
  public async addRatingUser (req: Request, res: Response) : Promise<void> {
    ...
    await User.findOneAndUpdate({ _id: userRated }, { personalRatings: user.personalRatings })
  ...
  public async addRatingActivity (req: Request, res: Response) : Promise<void> {
    ...
    await Activity.findOneAndUpdate({ _id: activityRated }, { ratings: activity.ratings })
