...
class MessageRoutes {
  ...
  public async addMessageUser (req: Request, res: Response) : Promise<void> {
    ...
    await User.findOneAndUpdate({ _id: newSender }, { messages: newSender.messages })

    newReceiver.messages.push(newMessage._id)
    await User.findOneAndUpdate({ _id: newReceiver }, { messages: newReceiver.messages })
  ...
  public async addMessageUserByName (req: Request, res: Response) : Promise<void> {
    ...
    await User.findOneAndUpdate({ name: req.body.sender }, { messages: newSender.messages })

    newReceiver.messages.push(newMessage._id)

    await User.findOneAndUpdate({ name: req.body.receiver }, { messages: newReceiver.messages })
  ...
  public async addMessageActivity (req: Request, res: Response) : Promise<void> {
    ...
    await Activity.findOneAndUpdate({ _id: newActivity }, { messages: newActivity.messages })
  ...
  public async addMessageActivityByName (req: Request, res: Response) : Promise<void> {
    ...
    await User.findOneAndUpdate({ name: req.body.activity }, { messages: newActivity.messages })
